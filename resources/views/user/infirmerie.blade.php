    ...
    <div class="max-w-7xl mx-auto bg-white  rounded-lg p-8 border border-gray-200">
        ...
        <div class="text-center mb-12">
            <div class="flex justify-center items-center space-x-3 mb-4">
                ...
                <h1 class="text-4xl font-extrabold text-gray-800">Infirmerie - ISEP de Thiès</h1>
            </div>
            <p class="text-gray-600 text-lg">Consultez les médicaments disponibles et gérez vos besoins médicaux en
                toute simplicité.</p>
        </div>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-green-50 transition">
                        ...
                        <td class="px-6 py-4 border">
                            <a href="{{ route('medicaments.details', $medicament->id) }}"
