            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-green-600 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider">Heure à prendre
                        </th>
                        ...
                        <td class="px-6 py-4 text-sm text-center">
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('medicaments.edit', $medicament) }}"
                                    class="border border-blue-500 hover:bg-blue-600 text-blue-600 hover:text-white px-3 py-2 rounded-lg text-sm font-medium flex items-center gap-1 transition">
                                    Modifier
                                </a>
                                <form action="{{ route('medicaments.destroy', $medicament) }}" method="POST"
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        class="border border-red-500 hover:bg-red-600 text-red-500 hover:text-whited px-3 py-2 rounded-lg text-sm font-medium flex items-center gap-1 transition">
                                        Supprimer
                                    </button>
                                </form>
                            </div>
